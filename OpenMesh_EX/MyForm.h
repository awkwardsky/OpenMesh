...
private: System::Void hkoglPanelControl1_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e)
{
	...
	if (mesh != NULL) {
		mesh->Render_Point();///選面、亮點
		mesh->Render_SolidWireframe();///選面、亮面
		///選點、亮點
		///選點、亮面
	}
	glPopMatrix();
...
private: System::Void hkoglPanelControl1_MouseDown(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e)
{
		...
		e->Button == System::Windows::Forms::MouseButtons::Middle)
	{
		...
		//cout << "windows(x, y, z): (" << e->X << ", " << hkoglPanelControl1->Height - e->Y << ", " << pixels << ")" << endl;
		//cout << "xf: " << endl << xf << endl;
		//cout << "projMatrix: " << *projMatrix << endl;
